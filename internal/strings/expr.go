...
func (se *StringExpr) Length() expr.Expr {
	return &stringOpExpr{
		input:      se.input,
		op:         "length",
		apply:      func(s series.Series) series.Series { return NewStringOps(s).Length() },
...
func (se *StringExpr) RuneLength() expr.Expr {
	return &stringOpExpr{
		input:      se.input,
		op:         "rune_length",
		apply:      func(s series.Series) series.Series { return NewStringOps(s).RuneLength() },
		outputType: datatypes.Int32{},
	}
}
...
func (se *StringExpr) ToUpper() expr.Expr {
	return &stringOpExpr{
		input:      se.input,
		op:         "to_upper",
		apply:      func(s series.Series) series.Series { return NewStringOps(s).ToUpper() },
...
func (se *StringExpr) ToLower() expr.Expr {
	return &stringOpExpr{
		input:      se.input,
		op:         "to_lower",
		apply:      func(s series.Series) series.Series { return NewStringOps(s).ToLower() },
		outputType: datatypes.String{},
	}
}
...
func (se *StringExpr) Contains(pattern string, literal bool) expr.Expr {
	return &stringOpExpr{
		input:      se.input,
		op:         "contains",
		apply:      func(s series.Series) series.Series { return NewStringOps(s).Contains(pattern, literal) },
...
func (se *StringExpr) StartsWith(pattern string) expr.Expr {
	return &stringOpExpr{
		input:      se.input,
		op:         "starts_with",
		apply:      func(s series.Series) series.Series { return NewStringOps(s).StartsWith(pattern) },
		outputType: datatypes.Boolean{},
	}
}
...
func (se *StringExpr) EndsWith(pattern string) expr.Expr {
	return &stringOpExpr{
		input:      se.input,
		op:         "ends_with",
		apply:      func(s series.Series) series.Series { return NewStringOps(s).EndsWith(pattern) },
		outputType: datatypes.Boolean{},
	}
}
...
func (se *StringExpr) Replace(pattern, replacement string, n int) expr.Expr {
	return &stringOpExpr{
		input:      se.input,
		op:         "replace",
		apply:      func(s series.Series) series.Series { return NewStringOps(s).Replace(pattern, replacement, n) },
		outputType: datatypes.String{},
	}
}
...
func (se *StringExpr) Slice(start, length int) expr.Expr {
	return &stringOpExpr{
		input:      se.input,
		op:         "slice",
		apply:      func(s series.Series) series.Series { return NewStringOps(s).Slice(start, length) },
		outputType: datatypes.String{},
	}
}
...
func (se *StringExpr) Strip() expr.Expr {
	return &stringOpExpr{
		input:      se.input,
		op:         "strip",
		apply:      func(s series.Series) series.Series { return NewStringOps(s).Strip() },
		outputType: datatypes.String{},
	}
}
...
func (e *stringOpExpr) String() string {
	return fmt.Sprintf("%s.%s", e.input.Name(), e.op)
}
